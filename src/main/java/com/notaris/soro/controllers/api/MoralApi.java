...
public interface MoralApi {
    ...
    @GetMapping(value = CLIENT_MORAL_END_POINT+ "/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<MoralDTO> findById(@PathVariable Integer id);

    @GetMapping(value = CLIENT_MORAL_END_POINT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<List<MoralDTO>> findAll();

    @GetMapping(value = CLIENT_MORAL_END_POINT+ "/{email}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<MoralDTO> findByEmail(@PathVariable String email);

    @GetMapping(value = CLIENT_MORAL_END_POINT+ "/{nom}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
